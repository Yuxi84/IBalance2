...
public class SensorHandler implements SensorEventListener{
    ...
    private double accelmagZ, accelmagX, accelmagY;
    private double gyroZ, gyroX, gyroY;
    private double zPos, xPos, yPos;

    //printwriter to send location data
    ...
    public SensorHandler(Context context, PrintWriter pw){
        this.pw = pw;
...
/*    public void setAccelMagValues(float[] values){
    ...
    public void sendFusedValues(){
        new Thread(new Runnable() {
            @Override
            public void run() {
                pw.println(xPos + " "+yPos);
            }
        }).start();
    }
// This function registers sensor listeners for the accelerometer, magnetometer and gyroscope.
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        setFusedValues(fusedOrientation);
        sendFusedValues();
